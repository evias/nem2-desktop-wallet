...
//  pie chart
    ...
    Multisign_transfer: 'Multisig transfer',
    ...
    a_namespace_is_a_domain_name_that_stores_mosaics_Each_namespace_is_unique_within_a_blockchain_and_mosaics_can_be_defined_and_authenticated_on_a_multi_level_sub_namespace: 'Namespaces are unique domain names on the blockchain. They can be used as addresses and mosaics aliases.',
    ...
    entrusted_harvesting_is_a_way_to_achieve_remote_online_mining_without_having_to_keep_the_original_account_open: 'Delegated harvesting is a way to mine coins withouth keeping the main wallet open on a remote server.',
    use_the_NEM_Apostille_service_to_create_blockchain_notarized_timestamps_to_track_and_audit_file_authentication_status: 'Apostille enables notarizing and checking the authenticity of files notarized on the NEM blockchain.',
...
//   monitor-transfer
    ...
    variable_supply: 'Mutable supply',
