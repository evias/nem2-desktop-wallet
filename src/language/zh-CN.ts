export const zh_CN = {
    ...
    yes: '是',
    no: '否',
    Please_enter_the_correct_number: '请输入正确金额',
    ...
    block: '块',
    message: '消息',
    Notes_should_not_exceed_25_character: '备注不能超过25字符',
    ...
    a_namespace_is_a_domain_name_that_stores_mosaics_Each_namespace_is_unique_within_a_block_chain_and_mosaics_can_be_defined_and_authenticated_on_a_multi_level_sub_namespace: '命名空间是存储马赛克的域名，每个命名空间在区块链中唯一，可在多层子命名空间上定义和认证马赛克。',
...
//   monitor-transfer
    ...
    switch_point: '选择节点',
    current_point: '当前节点',
    please_enter_a_custom_nod_address: '请输入节点地址',
...
// wallet detail
    ...
    Nem_wallet_can_not_recover_your_mnemonic: 'Nem wallet无法恢复您的助记词',
...
//mosaic transaction
    ...
    Harvester: '收获者',
    // login
    WELCOME_TO_CATAPULT_NANO_WALLET: '欢迎使用CATAPULT-Wallet测试版',
    ...
    delete_wallet_tip: '请注意，您正在删除钱包%{walletName}, 若无妥善备份，删除钱包后将无法找回钱包，请谨慎处理该操作。 同时，为了确保是本人操作，请输入钱包密码。',
    delete_wallet: '删除钱包',

    register_namespace: '注册/续费命名空间',
    address_alias: '地址别名',
    mosaic_alias: '马赛克别名',
    mosaic_definition: '马赛克定义',
    mosaic_supply_change: '马赛克供应量修改',
    modify_multisig_account: '修改多签账户',
    aggregate_complete: '聚合完成',
    aggregate_bonded: '聚合绑定',
    lock: '交易锁',
    secret_lock: '密码锁定',
    secret_proof: '密码解密',
    modify_account_property_address: '地址阻止',
    modify_account_property_mosaic: '马赛克阻止',
    modify_account_property_entity_type: '实体类型阻止',
    link_account: '远程收获',
    ...
    The_wallet_terminal_will_use_the_HD_WALLET_protocol_to_provide_1: '本钱包终端将采用HD-WALLET协议，提供给方便的钱包管理，',
    The_wallet_terminal_will_use_the_HD_WALLET_protocol_to_provide_2: '账户默认钱包将会是一个记助词钱包；遵循一个账户，一个种子，一个密码的原则；',
    The_wallet_terminal_will_use_the_HD_WALLET_protocol_to_provide_3: '所以一个账户下可以有多个钱包列表，用账户密码管理，一旦忘记密码，可以通过导入助记词恢复钱包；在程序的启动页你可以方便的切换到其他账户。',
    ...
    Mosaic_alias: '马赛克别名',
    Namespace_and_Sub_Namespace: '命名空间和子空间',
    Under_the_current_wallet: '当前钱包下，命名空间及子命名空间资产列表、事务管理列表',
    define: '定义',
    A_namespace_starts_with_a_name_that_you_choose_similar_to_an_internet_domain_name: '命名空间使您可以在NEM区块链上为您的业务和资产创建一个链上唯 一的标识符，类似于互联网域名。',
