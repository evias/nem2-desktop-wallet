<template>
  <div class="transaction-list-container radius"
    ...
    <PageTutorial v-if="!isMinimized"
                  :pageTitle="'tutorial_transaction_list_title'"
                  :titles="['tutorial_transaction_title_1', 'tutorial_transaction_title_2', 'tutorial_transaction_title_3']"
                  :explanations="[
                    'tutorial_transaction_explanation_1',
                    'tutorial_transaction_explanation_2',
